...
public class UsersScreen extends AppCompatActivity {
    ...
    public void getLastLocation() {
        ...
        if(ContextCompat.checkSelfPermission(UsersScreen.this, Manifest.permission.ACCESS_FINE_LOCATION)== PackageManager.PERMISSION_GRANTED){
            ...
            ubication.getLastLocation().addOnSuccessListener(UsersScreen.this, new OnSuccessListener<Location>() {
                ...
                public void onSuccess(Location location) {
                    ...
                    LocationUser lu=new LocationUser("s",Double.toString(location.getLatitude()),Double.toString(location.getLongitude()), LocalDateTime.now().toString());
    ...
    public void checkPermisos(){
        ...
        int permiso3=ContextCompat.checkSelfPermission(UsersScreen.this,Manifest.permission.ACCESS_BACKGROUND_LOCATION);
        System.out.println("permiso 1"+permiso1);
        System.out.println("permiso 2"+permiso2);
        System.out.println("permiso 3"+permiso3);
        if(permiso1== PackageManager.PERMISSION_GRANTED&&permiso2== PackageManager.PERMISSION_GRANTED&&permiso3== PackageManager.PERMISSION_GRANTED){
